			...
			function()
				...
				return vim.tbl_map(function(cmd)
					return vim.tbl_extend("force", {
						pane = 2, section = "terminal", enabled = in_git,
						padding = 1, ttl = 5 * 60, indent = 3,
					}, cmd)
				end, cmds)
			end,
		},
...
map("n", "<leader>e", function()
	Snacks.explorer({
		layout = { preset = "default", preview = true },
		ignored = true, hidden = true, auto_close = true,
	})
...
map("n", "<leader>E", function()
	...
	Snacks.explorer({
		layout = { preset = "default", preview = true },
		cwd = root, ignored = true, hidden = true, auto_close = true,
	})
